...
from ._exceptions import ParseocrError, APIStatusError
...
class Parseocr(SyncAPIClient):
    ...
    def __init__(
        ...
        *,
        ...
        """Construct a new synchronous Parseocr client instance.

        This automatically infers the `api_key` argument from the `PARSEOCR_API_KEY` environment variable if it is not provided.
        """
        if api_key is None:
            api_key = os.environ.get("PARSEOCR_API_KEY")
        if api_key is None:
            raise ParseocrError(
                "The api_key client option must be set either by passing api_key to the client or by setting the PARSEOCR_API_KEY environment variable"
            )
        ...
        custom_headers_env = os.environ.get("PARSEOCR_CUSTOM_HEADERS")
    ...
    @cached_property
    def with_raw_response(self) -> ParseocrWithRawResponse:
        return ParseocrWithRawResponse(self)

    @cached_property
    def with_streaming_response(self) -> ParseocrWithStreamedResponse:
        return ParseocrWithStreamedResponse(self)
...
class AsyncParseocr(AsyncAPIClient):
    # client options
    api_key: str
    ...
    def __init__(
        ...
        *,
        ...
        """Construct a new async AsyncParseocr client instance.
    ...
    @cached_property
    def with_raw_response(self) -> AsyncParseocrWithRawResponse:
        return AsyncParseocrWithRawResponse(self)

    @cached_property
    def with_streaming_response(self) -> AsyncParseocrWithStreamedResponse:
        return AsyncParseocrWithStreamedResponse(self)
...
class ParseocrWithRawResponse:
    _client: Parseocr

    def __init__(self, client: Parseocr) -> None:
        self._client = client
...
class AsyncParseocrWithRawResponse:
    _client: AsyncParseocr

    def __init__(self, client: AsyncParseocr) -> None:
        self._client = client
...
class ParseocrWithStreamedResponse:
    _client: Parseocr
...
class AsyncParseocrWithStreamedResponse:
    _client: AsyncParseocr
