...
class ClassifyResource(SyncAPIResource):
    ...
    def with_raw_response(self) -> ClassifyResourceWithRawResponse:
        ...
        For more information, see https://www.github.com/parseocr/parseocr-python#accessing-raw-response-data-eg-headers
        """
    ...
    def with_streaming_response(self) -> ClassifyResourceWithStreamingResponse:
        ...
        For more information, see https://www.github.com/parseocr/parseocr-python#with_streaming_response
        """
